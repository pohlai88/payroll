...
function LedgerLine({ row }: { readonly row: LedgerRow }) {
	return (
		<tr className="group border-rule-hair border-b align-baseline last:border-0 hover:bg-paper-deep/40 transition-colors">
					...
					<div className="grain rounded-sm border border-rule bg-paper-card p-6 md:p-9">
						...
						<div className="mt-8 flex items-center gap-2 border-rule border-t pt-4">
							...
							<p className="font-mono text-[0.65rem] text-ink-faint">
								Rule pack {" "}
								<span className="text-ink">MY-STATUTORY-2026-06</span>
					...
					<aside className="flex flex-col gap-8 lg:pt-4">
						...
						<div className="rounded-sm border border-rule bg-paper p-5">
							...
							<dl className="mt-4 space-y-2.5">
								...
								<div className="border-rule border-t pt-2.5 flex justify-between">
									<dt className="font-medium text-sm text-ink">Net</dt>
									<dd className="figure-nums font-display text-lg text-ledger">
										{formatSen(NET_SEN)}
									</dd>
								</div>
							</dl>
