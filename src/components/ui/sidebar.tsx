...
function SidebarProvider({
  ...
  const setOpen = useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // This sets the cookie to keep the sidebar state (UI preference only,
      // not sensitive data), matching the shadcn/ui sidebar pattern.
      // biome-ignore lint/suspicious/noDocumentCookie: non-sensitive UI preference cookie; Cookie Store API isn't universally supported and this is vendor shadcn code.
